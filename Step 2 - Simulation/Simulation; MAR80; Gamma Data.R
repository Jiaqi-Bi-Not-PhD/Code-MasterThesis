...
simulated_dataset_500_MAR_Data_Gamma20 <- readRDS("simulated_dataset_500_MAR80_Data_Gamma.RData")
...
AllSimResults <- bind_rows(results_CCA, sim_results_noKlogT, 
                           ...
                           sim_results_KH0T)
saveRDS(AllSimResults, "MAR80 Gamma Well Specified; Simulation Results.RData")